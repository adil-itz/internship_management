...
import { PlusCircle, Search, Filter, BookOpen, Eye, Edit, Trash2, CheckCircle2, ShieldAlert, Sparkles } from 'lucide-react';
import DashboardLayout from '../../components/DashboardLayout';
import CourseStatusBadge from '../../components/courses/CourseStatusBadge';
import DeleteCourseModal from '../../components/courses/DeleteCourseModal';
import { getCourses, deleteCourse } from '../../services/course.service';

export default function AdminCourses({ darkMode, setDarkMode, user }) {
      ...
      <div className="space-y-6">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="space-y-2 max-w-2xl">
              ...
              <p className="text-blue-100 text-xs sm:text-sm leading-relaxed">
                Supervise, inspect, edit, publish, or delete any course pathway across the platform.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                placeholder="Search courses by title or creator name..."
        ...
        {loading ? (
          ...
          <div className="p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-center space-y-4 shadow-2xs">
            <p className="text-sm font-extrabold text-slate-900 dark:text-white">No courses available</p>
          </div>
        ) : (
