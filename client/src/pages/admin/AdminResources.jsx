...
import { PlusCircle, Search, Filter, Video, Eye, Edit, Trash2, CheckCircle2, ShieldAlert, Sparkles } from 'lucide-react';
...
export default function AdminResources({ darkMode, setDarkMode, user }) {
      ...
      <div className="space-y-6">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="space-y-2 max-w-2xl">
              ...
              <p className="text-blue-100 text-xs sm:text-sm leading-relaxed">
                Supervise, inspect, edit, publish, or remove any learning resource across all users.
              </p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                placeholder="Search resources by title or creator name..."
        ...
        {loading ? (
          ...
          <div className="p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-center space-y-4 shadow-2xs">
            <p className="text-sm font-extrabold text-slate-900 dark:text-white">No resources available</p>
          </div>
        ) : (
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs">
                  {filteredList.map((item) => (
                    <tr key={item._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="p-4 text-slate-600 dark:text-slate-300">{item.createdBy?.name || 'Mentor'}</td>
                      <td className="p-4">
                      ...
                      <td className="p-4 pr-6 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Link
                            to={`/admin/resources/${item._id}/edit`}
