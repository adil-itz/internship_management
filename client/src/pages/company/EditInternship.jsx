...
export default function EditInternship({ darkMode, setDarkMode, user }) {
    ...
    return (
      <DashboardLayout user={activeUser} darkMode={darkMode} setDarkMode={setDarkMode}>
        <div className="p-8 rounded-3xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300 text-center space-y-3">
          ...
          <p className="text-xs text-rose-600/80">The requested internship posting could not be retrieved for editing.</p>
        </div>
      </DashboardLayout>
    );
  }
  ...
  return (
    <DashboardLayout user={activeUser} darkMode={darkMode} setDarkMode={setDarkMode} activeTab="manage-internships">
