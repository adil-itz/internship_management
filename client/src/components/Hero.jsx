...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative pt-10 pb-20 overflow-hidden bg-gradient-to-b from-blue-50/80 via-slate-50/50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed mb-8 max-w-xl">
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-4 mb-10">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                href="#features"
                className="px-7 py-3.5 text-base font-semibold text-slate-800 dark:text-slate-200 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center gap-2 cursor-pointer"
              >
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-6 pt-6 border-t border-slate-200 dark:border-slate-800 text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          >
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200/80 dark:border-slate-800 overflow-hidden text-left hover-lift">
